...
public class SolitaireController {
	...
	public static void testDeplacement(List<List<Carte>> colonnes) {
		...
		deplacerColonne(colonnes,8,9,0);// Déplacer les cartes de la colonne 8 à la colonne 9 à partir de l'index 0 de la colonne 8
	}
	...
	public static boolean deplacerColonne(List<List<Carte>> colonnes, int colonneSource, int colonneDestination, int indexCarte) {
	    ...
	    // Déplacement des cartes dévoilées de la colonne source vers la colonne destination à partir de l'index indiqué
